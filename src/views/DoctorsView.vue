      ...
      <div class="container">
        ...
        <div class="tab-block__contents">
          ...
          <div class="tab-block__content" v-bind:class="{'is-active': currentTab===1}">
            ...
            <FavoriteDoctors :doctors="alldocs"></FavoriteDoctors>
          </div>
        </div>
      </div>
    </div>
    <FiltersPopup :directions="direct" :sortBy="sort"></FiltersPopup>
    ...
    computed: {
      filteredDir() {
        if (!this.checked.length)
          return this.alldocs
        return this.alldocs.filter(j => this.checked.includes(j.dir))
      }
    }
  }
</script>
